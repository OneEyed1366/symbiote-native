...
package ships `src/{core,react,vue,svelte,angular}/index.ts`; the framework barrels used to
hand-list the entire core surface by name — 4 copies to sync, per package. 15 packages already
