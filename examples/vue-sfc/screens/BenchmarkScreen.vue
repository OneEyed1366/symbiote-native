...
// krausest's row counts are DOM-node counts, not ours: BenchmarkRow.vue expands to TEN native
// views (1 View + 3x[Text + RawText] + 2 Pressable Views + 1 TextInput, no children), so 10 000
// rows is 100 000 UIViews - a ceiling the native host hits, not the engine.
