# Vue canary — SFC (`@symbiote-native/vue` on device)

A Vue 3 app driving the framework-agnostic
`@symbiote-native/engine` core on the iOS simulator / Android emulator, with React Native's own
