...
// @symbiote-native/css-parser devDependency: @symbiote-native/angular/metro-css-parser re-exports it from
...
const { createCssMetroTransformer } = require('@symbiote-native/angular/metro-css-parser');
