...
// @symbiote/css-parser devDependency: @symbiote/angular/metro-css-parser re-exports it from
...
const { createCssMetroTransformer } = require('@symbiote/angular/metro-css-parser');
