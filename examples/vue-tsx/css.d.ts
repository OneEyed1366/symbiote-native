...
// Mirrors examples/react/css.d.ts and examples/angular/css.d.ts.
declare module '*.css';
...
// `@symbiote-native/vue/typescript-plugin` entry in tsconfig.json's `compilerOptions.plugins` gives the
