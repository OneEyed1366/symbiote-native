...
const MENU_ITEMS: readonly IMenuItem[] = [
  ...
  },
  {
    ...
    hint: '@symbiote-native/file-system — legacy function-based API and the modern File/Directory/Paths API',
  },
  {
    label: 'Audio',
  ...
  },
  {
    ...
    hint: '@symbiote-native/notifications — permissions, scheduling, presentation, badges, channels, and listeners',
  },
  {
    label: 'Background Tasks',
    route: ROUTE_NAME.BackgroundTasks,
    hint: '@symbiote-native/task-manager + @symbiote-native/background-fetch + @symbiote-native/background-task',
  },
  {
    label: 'SQLite',
    route: ROUTE_NAME.Sqlite,
    hint: '@symbiote-native/sqlite — SQLiteProvider/useSQLiteContext, CRUD, transactions with rollback, and a SQLite-backed key-value store',
  },
];
