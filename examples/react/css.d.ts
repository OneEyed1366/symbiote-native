...
// Mirrors examples/angular/css.d.ts. See the symbiote-sfc-style-compiler skill.
declare module '*.css';
...
// `@symbiote-native/react/typescript-plugin` entry in tsconfig.json's `compilerOptions.plugins` gives
