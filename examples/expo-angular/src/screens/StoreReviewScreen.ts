...
import { hasAction, isAvailableAsync, requestReview } from '@symbiote-native/store-review/angular';
        ...
        <View class="hero-card">
          ...
          <View class="hero-copy">
            ...
            <Text class="hero-body">
              @symbiote-native/store-review — the native App Store/Play Store review prompt,
              letting a user rate the app without leaving it.
            </Text>
          </View>
        </View>
        ...
        <View testID="store-review-capability-card" class="capability-card">
          ...
          <View testID="store-review-has-action" class="capability-row">
            ...
            <View [class]="statusBadgeClass(hasReviewAction())">
              <Text class="status-badge-text">{{ statusLabel(hasReviewAction()) }}</Text>
            </View>
          </View>
        </View>
