...
const MENU_ITEMS: readonly IMenuItem[] = [
  ...
  { label: 'Web Crypto', route: ROUTE_NAME.StandardWebCrypto, hint: '@symbiote-native/standard-web-crypto — partial W3C Web Crypto polyfill (crypto.getRandomValues)' },
  { label: 'System UI', route: ROUTE_NAME.SystemUi, hint: '@symbiote-native/system-ui — get/set the root view background color' },
  { label: 'Store Review', route: ROUTE_NAME.StoreReview, hint: '@symbiote-native/store-review — native App Store/Play Store review prompt' },
  { label: 'Keep Awake', route: ROUTE_NAME.KeepAwake, hint: '@symbiote-native/keep-awake — keep the screen on for as long as a tag stays active' },
  { label: 'Screen Orientation', route: ROUTE_NAME.ScreenOrientation, hint: '@symbiote-native/screen-orientation — lock/unlock the screen orientation, live orientation changes' },
  { label: 'Localization', route: ROUTE_NAME.Localization, hint: '@symbiote-native/localization — device locales and calendars' },
  { label: 'Tracking Transparency', route: ROUTE_NAME.TrackingTransparency, hint: '@symbiote-native/tracking-transparency — App Tracking Transparency permission + advertising ID' },
];
