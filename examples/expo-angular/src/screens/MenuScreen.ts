...
const MENU_ITEMS: readonly IMenuItem[] = [
  ...
  },
  {
    ...
    hint: '@symbiote-native/file-system — legacy read/write/copy/move/delete + the modern File/Directory/Paths API',
  },
  {
    label: 'Audio',
  ...
  },
  {
    ...
    hint: '@symbiote-native/notifications — permissions, scheduling, presentation, badges, Android channels, live listeners',
  },
  {
  ...
  },
  {
    ...
    hint: '@symbiote-native/sqlite — Database/Statement/Session, the SQL tagged-template helper, transactions, and a key-value store',
  },
];
