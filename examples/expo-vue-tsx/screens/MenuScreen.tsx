...
const MENU_ITEMS: readonly IMenuItem[] = [
  ...
  { label: 'Web Crypto', route: ROUTE_NAME.StandardWebCrypto, hint: '@symbiote-native/standard-web-crypto — W3C crypto.getRandomValues polyfill' },
  ...
  { label: 'Keep Awake', route: ROUTE_NAME.KeepAwake, hint: '@symbiote-native/keep-awake — keep the screen on while a component is mounted' },
  { label: 'Screen Orientation', route: ROUTE_NAME.ScreenOrientation, hint: '@symbiote-native/screen-orientation — lock/unlock orientation, live orientation state' },
  { label: 'Localization', route: ROUTE_NAME.Localization, hint: '@symbiote-native/localization — user locales and calendar preferences' },
