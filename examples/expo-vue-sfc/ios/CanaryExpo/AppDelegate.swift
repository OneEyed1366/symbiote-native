...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  // any autolinked Expo module that registers a subscriber keeps working — the sensors package
  // registers none, but this keeps future expo-modules-core packages working for free.
