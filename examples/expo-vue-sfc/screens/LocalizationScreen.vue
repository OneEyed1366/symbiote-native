...
<template>
  <safe-area-view class="screen">
    ...
    >
      ...
      <view
        testID="localization-locale-card"
        class="localization-card"
      >
        <text class="localization-card-title">
          First locale
        </text>
        <view class="localization-row">
          <text class="localization-row-label">
            Language tag
          </text>
          <text
      ...
      <view
        testID="localization-calendar-card"
        class="localization-card"
      >
        <text class="localization-card-title">
          First calendar
