<script lang="ts">
  // Drop-in replacement for RN's stock <Button> (same title/onPress/color/testID surface) — a
  // bare Button renders as unstyled tinted text on iOS, visually indistinguishable from a body
