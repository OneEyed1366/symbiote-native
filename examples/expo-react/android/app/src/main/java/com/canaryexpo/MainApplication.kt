...
private class ExpoModulesProvider : ModulesProvider {
  // SYMBIOTE-EXPO-LINK:BEGIN SERVICES (generated by symbiote-expo-link - do not edit, regenerated on every install)
  override fun getServices(): List<Class<out Service>> = listOf(
    ConstantsService::class.java,
  )
  // SYMBIOTE-EXPO-LINK:END SERVICES
  override fun getModulesMap(): Map<Class<out Module>, String?> = mapOf(
    ...
    AndroidXNotificationsChannelsProvider::class.java to "NotificationsChannelsProvider",
