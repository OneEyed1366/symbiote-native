...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  // any autolinked Expo module that registers a subscriber keeps working — the sensors modules
  ...
  func application(
    ...
    ExpoAppDelegateSubscriberManager.application(application, open: url, options: options)
  }
