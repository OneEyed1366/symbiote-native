// @symbiote-native/application/svelte: the Svelte entry over the framework-agnostic core.
// Upstream ships plain constants and one-shot async functions, no per-instance state and no
// event stream — there is nothing for a rune to wrap, so this is a plain re-export. Svelte's
