// @symbiote-native/secure-store/svelte: the Svelte entry over the framework-agnostic core.
// Upstream ships free functions and seven constants, no per-instance state and no event stream
// — there is nothing for a rune to wrap, so this is a plain re-export. Svelte's lifecycle
