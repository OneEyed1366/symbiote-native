...
type IExponentDeviceMotionModule =
  INativeSensorModule<IDeviceMotionMeasurement> & {
    Gravity: number;
  };

export const exponentDeviceMotion =
  requireNativeModule<IExponentDeviceMotionModule>(
