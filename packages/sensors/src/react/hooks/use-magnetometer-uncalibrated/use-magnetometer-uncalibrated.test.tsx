...
// already has its own coverage in packages/sensors/src/core/magnetometer-uncalibrated.test.ts.
//
// No Negative group: the hook has no guard clause and nothing to reject — every prop shape
// the type system allows flows straight into MagnetometerUncalibrated.addListener/
// setUpdateInterval, so every scenario below is Positive.
...
// surface covered by magnetometer-uncalibrated.test.ts.
