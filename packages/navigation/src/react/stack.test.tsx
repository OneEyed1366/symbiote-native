...
describe('React Stack navigator', () => {
  ...
  it('passes route.params through to the screen component via navigation.push', () => {
    let receivedParams: unknown;
    function ParamsScreen(props: { route: { params: unknown } }): ReturnType<typeof createElement> {
  ...
  it('setParams() targets a route by key when given, not just the focused one', () => {
    ...
    function HomeTrackingScreen(props: {
      route: { key: string; params: unknown };
