// @symbiote-native/tracking-transparency/svelte: the Svelte entry over the framework-agnostic core.
// Same reasoning as the React and Vue entries — only the permission surface gets a lifecycle rune,
