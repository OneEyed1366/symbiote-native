/**
 * Detox e2e config. Detox attaches at the stock RN host, below the renderer symbiote replaces, so
 * this is the same wiring any RN app uses. Two configurations: ios.sim.debug and android.emu.debug.
