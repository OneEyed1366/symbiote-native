...
export enum ImpactFeedbackStyle {
  ...
  Heavy = 'heavy',
  /**
   * A collision between user interface elements that are soft, exhibiting a large amount of
   * compression or elasticity.
   */
  Soft = 'soft',
  /**
   * A collision between user interface elements that are rigid, exhibiting a small amount of
   * compression or elasticity.
   */
  Rigid = 'rigid',
}
...
export enum AndroidHaptics {
   ...
   * clock face or individual percentages. Expected to be very soft, so as not to be uncomfortable
   * when performed a lot in quick succession — if the device can't make a suitably soft
   * vibration, it may not make any vibration at all.
   */
