---
title: Quick start
description: Run the existing SymbioteJS examples and inspect the first native app driven through the shared engine.
---

:::note Run from source
SymbioteJS is a renderer project under active development. The quickest way to try
...
The React example is the reference canary: it drives the SymbioteJS engine through
...
Next, read [how it works](/symbiote-native/docs/how-it-works/) to understand the render pipeline.
