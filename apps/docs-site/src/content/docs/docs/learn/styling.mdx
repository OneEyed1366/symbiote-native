---
title: Styling
description: Style SymbioteNative native views with CSS classes, CSS Modules, or StyleSheet.create.
---
...
Angular, Svelte) styles this way. `StyleSheet.create` — React Native's own JS-object
...
misapplied. Tailwind CSS is not supported. Everything else — plain CSS
...
same way across React, Vue, Angular, and Svelte, including Svelte's own
...
```ts
import { Component } from '@angular/core';
import { StyleSheet, Text, View } from '@symbiote-native/angular';
