...
<video poster={`${import.meta.env.BASE_URL}/angular-demo.webp`} aria-label="Angular driving a native SymbioteNative demo" width="260" height="564" preload="none" autoplay muted loop playsinline>
