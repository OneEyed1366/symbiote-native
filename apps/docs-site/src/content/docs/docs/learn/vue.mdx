---
title: Vue guide
description: How to write SymbioteNative apps with the Vue adapter.
---
...
<video poster={`${import.meta.env.BASE_URL}/vue-demo.webp`} aria-label="Vue SFC driving a native SymbioteNative demo" width="260" height="564" preload="none" autoplay muted loop playsinline>
...
<video poster={`${import.meta.env.BASE_URL}/vue-tsx-demo.webp`} aria-label="Vue TSX driving a native SymbioteNative demo" width="260" height="564" preload="none" autoplay muted loop playsinline>
  <source src={`${import.meta.env.BASE_URL}/vue-tsx-demo.mp4`} type="video/mp4" />
  <source src={`${import.meta.env.BASE_URL}/vue-tsx-demo.webm`} type="video/webm" />
</video>
