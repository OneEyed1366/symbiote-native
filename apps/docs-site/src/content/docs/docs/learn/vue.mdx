...
<img src={`${import.meta.env.BASE_URL}/vue-demo.gif`} alt="Vue SFC driving a native SymbioteNative demo" width="260" />

*Vue SFC (`.vue`) — the reference canary at `examples/vue-sfc`.*

<img src={`${import.meta.env.BASE_URL}/vue-tsx-demo.gif`} alt="Vue TSX driving a native SymbioteNative demo" width="260" />
