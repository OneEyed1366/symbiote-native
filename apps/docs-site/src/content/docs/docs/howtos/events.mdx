...
## Angular — real `@Output()` `EventEmitter`s
...
stayed a raw passthrough listener, see the [Events guide](/symbiote-native/docs/learn/events/)
and the [Components API](/symbiote-native/docs/api/components/).
