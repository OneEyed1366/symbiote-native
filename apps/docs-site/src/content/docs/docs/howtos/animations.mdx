...
```tsx
import { Animated } from '@symbiote-native/react'; // or '@symbiote-native/vue' / '@symbiote-native/angular' / '@symbiote-native/solid'
...
Wrap the view you want to animate in `Animated.View` — the dotted form works
as written on React, Vue, Svelte and Solid. Angular is the exception: import
`AnimatedView` by name there, because its AOT compiler cannot trace a component
class through property access. See the [Animations guide](/docs/learn/animations/) for the full
