...
native view through the same `createNode`-by-ViewConfig path SymbioteJS uses
...
the project's
[`symbiote-third-party-native-view`](https://github.com/OneEyed1366/symbiote-native/blob/master/.claude/skills/symbiote-third-party-native-view/SKILL.md)
skill.
