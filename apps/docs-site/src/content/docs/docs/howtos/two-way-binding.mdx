...
[`@symbiote-native/slider`](/symbiote-native/docs/packages/slider/) wrapper package
...
[Events guide](/symbiote-native/docs/learn/events/#controlled-components) and the
[Vue API reference](/symbiote-native/docs/api/vue/#model-bindings-v-model).
