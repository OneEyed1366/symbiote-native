...
<Tabs syncKey="framework">
  ...
  <TabItem label="Solid">
    ...
    import { createLocales, createCalendars } from '@symbiote-native/localization/solid';
    ...
    Both primitives return an `Accessor`, not a plain value: call them, `locales()`, like any
    other Solid signal, since a component body runs once.
...
`@symbiote-native/localization` ships zero React/Vue/Angular/Svelte/Solid logic in `expo-localization` itself
