...
state, so there is no hook/composable/service to wrap — the React, Vue, Angular, Svelte, and
...
<Tabs syncKey="framework">
  ...
  <TabItem label="Solid">
    ...
    import { Button, Text, View } from '@symbiote-native/solid';
...
└── solid/    # @symbiote-native/sharing/solid   — export * from '../core'
```
