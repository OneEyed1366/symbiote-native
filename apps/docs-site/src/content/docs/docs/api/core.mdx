...
Most app code should import from `@symbiote-native/react` or `@symbiote-native/vue`. The core
...
`@symbiote-native/vue`, and `@symbiote-native/angular` all declare it as a peer
...
```ts
import { AppRegistry, setHostRegistrar } from '@symbiote-native/react'; // or '@symbiote-native/vue' / '@symbiote-native/angular'
