...
@Component({
  standalone: true,
  imports: [ReactiveFormsModule, Switch, TextInput],
  template: `
    <TextInput [formControl]="email" placeholder="email" />
...
React, Vue, and Solid have the same primitive — see their own API references.
