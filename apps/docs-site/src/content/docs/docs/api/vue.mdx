...
- Styles: `:style="styles.root"` with React Native-style objects. Most
  ...
  the [Styling guide](/symbiote-native/docs/learn/styling/).
...
`Switch`, `TextInput`, and the [Slider](/symbiote-native/docs/packages/slider/) wrapper accept
...
from `@symbiote-native/vue` — see the [Animations guide](/symbiote-native/docs/learn/animations/)
...
described in the [Core API](/symbiote-native/docs/api/core/#app-entry-point-appregistry). One
