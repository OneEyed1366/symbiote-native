...
| Styles          | `style={styles.root}` with React Native-style objects, or `className` for a registered CSS class (see the [Styling guide](/symbiote-native/docs/learn/styling/)) |
...
from `@symbiote-native/react` — see the [Animations guide](/symbiote-native/docs/learn/animations/)
...
[Vue API reference](/symbiote-native/docs/api/vue/#portals-teleport).
...
described in the [Core API](/symbiote-native/docs/api/core/#app-entry-point-appregistry). A
