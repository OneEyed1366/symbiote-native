...
- fd70625: Bridge headless-task registrations into React Native's callable AppRegistry, including tasks
  registered before adapter bootstrap attaches the host.
- 6e6df80: Keep synthesized presses scoped to their owning target: additional fingers inside one owner
