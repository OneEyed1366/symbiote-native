...
let imageStatics: typeof import('./index').imageStatics;
let setImageSourceResolver: typeof import('../image-source-resolver/index').setImageSourceResolver;
...
beforeEach(async () => {
  ...
  vi.resetModules();
  ({ imageStatics } = await import('./index'));
  ({ setImageSourceResolver } = await import('../image-source-resolver/index'));
});
