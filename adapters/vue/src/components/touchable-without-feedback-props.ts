// The prop surface of `<touchable-without-feedback>`, for Vue.
//
...
// because RN's TWF never clones it: the prop is declared upstream (:122, tagged "FIXME: not in
// doc") and left out of `elementProps`, so on the tag it would sit on a node that never commits.
