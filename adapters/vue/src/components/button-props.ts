// The prop surface of `<button>`, for Vue.
//
...
// something, the same reason `touchable-native-feedback-props.ts` next door survived that move.
//
...
// field is per-adapter, and Vue spells it `class`.
import type { IClassNameValue } from '@symbiote-native/engine';
import type { IButtonProps as ICoreButtonProps } from '@symbiote-native/components';

export type IButtonProps = ICoreButtonProps & { class?: IClassNameValue };
