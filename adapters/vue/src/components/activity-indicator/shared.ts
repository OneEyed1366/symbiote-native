...
import type { IClassNameValue, IViewStyle } from '@symbiote-native/engine';
import { descriptorToVue } from '../../descriptor-to-vue';
import { normalizeVueAttrs } from '../../utils/normalize-attrs';

// IActivityIndicatorProps lives framework-agnostic in @symbiote-native/components; `class` can't join
