...
export const TextInput = forwardRef<ITextInputHandle, ITextInputProps>(
  (rawProps, forwardedRef) => {
    ...
    // setTextAndSelection.
    const lastNativeText = useRef<string | undefined>(
      foldText(value, defaultValue),
    );
