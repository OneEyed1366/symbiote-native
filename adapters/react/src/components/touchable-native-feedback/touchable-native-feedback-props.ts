// The prop surface of `<touchable-native-feedback>`, for React.
//
...
// (<prop_types_split_agnostic_vs_per_adapter>). `style` is absent because RN's TNF declares none —
// the drawable is the whole visual, and a `style` on this tag would sit on a node that never
// commits.
