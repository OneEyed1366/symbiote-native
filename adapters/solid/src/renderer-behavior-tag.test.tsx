...
//
// The host-behavior registry is keyed by tag (`pressable`), while a node only ever carries
...
// would be worse: `pressable` and a plain `<View>` both resolve to `RCTView`, so every
...
// `pressable` yet, so all 447 other Solid tests stay green with the tag argument removed.
