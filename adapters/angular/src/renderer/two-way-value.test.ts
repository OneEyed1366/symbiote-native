...
// Asked of the HOST, not read off a field: JS holds no props, and a FUNCTION prop never crossed the
// wire at all — `propOf` consults the stash that holds it first, which is exactly the key this
// checks.
